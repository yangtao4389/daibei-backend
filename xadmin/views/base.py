...
class BaseAdminView(BaseAdminObject, View):
    ...
    def __init__(self, request, *args, **kwargs):
        ...
        # print(self.user,'uuuuuuuuuuu','AnonymousUser')
    ...
    def get_context(self):
        ...
        # return {'admin_view': self, 'media': self.media, 'base_template': self.base_template,  "xadminlogoutUrl": self.request.session['xadminlogoutUrl'],}
